    ...
    <div className='flex flex-col items-center justify-center min-h-screen bg-white'>
        <div className='w-full max-w-sm'>
            ...
            className='bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                >
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-color-filter"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M13.58 13.79c.27 .68 .42 1.43 .42 2.21c0 1.77 -.77 3.37 -2 4.46a5.93 5.93 0 0 1 -4 1.54c-3.31 0 -6 -2.69 -6 -6c0 -2.76 1.88 -5.1 4.42 -5.79" /><path d="M17.58 10.21c2.54 .69 4.42 3.03 4.42 5.79c0 3.31 -2.69 6 -6 6a5.93 5.93 0 0 1 -4 -1.54" /><path d="M12 8m-6 0a6 6 0 1 0 12 0a6 6 0 1 0 -12 0" /></svg>

                </button>

</div>

     <div className={`flex justify-between focus:border-blue-500 border px-1 rounded ${
...
{error && (
  <p className="text-red-500 text-sm mt-1">{error}</p>
                ...
                <div className='flex justify-center mb-4'>
                    <Link to='/tailwinddemo3' className='text-blue-600 tx-sm'>Forget Password</Link><br/>
                </div>          
