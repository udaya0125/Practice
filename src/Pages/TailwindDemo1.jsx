        ...
        <section className="w-3/4">
          <form onSubmit={handleSubmit} className="mb-10">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center space-x-2">
                <span>
                  Your email address is <b>emailis@private.com</b>
                </span>
                <button
                  onClick={() => navigate("/")}
          ...
          <div className="mt-10">
            ...
            <p className="mb-2 text-gray-700">
              ...
              <span className="font-bold">1388 posts</span>. Deleting your
