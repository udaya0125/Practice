...
const TailWindDemo6 = () => {
    ...
    const handleChange =(e)=>{
        ...
        if (!/^((https?|ftp):\/\/)?(www\.)?[a-zA-Z0-9-]+(\.[a-zA-Z]{2,})+(\/[\w./?%&=-]*)?$/
.test(formData.link)) {
    ...
    <div className='fixed inset-0  flex items-center justify-center'>
        <div className='bg-white rounded-t-2xl rounded-b-lg shadow-lg w-full max-w-md  '>
            <div className='bg-blue-700 rounded-t-2xl px-6 py-6 flex justify-between ' >
                <h2 className=' text-white text-2xl font-semibold mx-auto '>Submit a tool</h2>
            </div>
            ...
            <form className='px-6 py-8 rounded-3xl' onSubmit={handleSubmit}>
              ...
              <option value="development">Development</option>
                 ...
                 <button 
                type='submit'
                className='w-full py-3 bg-blue-900 hover:bg-blue-700  text-white text-lg font-semibold rounded-full shadow-md transition'>Submit</button>
