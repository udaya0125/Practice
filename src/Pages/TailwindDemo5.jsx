    ...
    <div className="flex flex-col md:flex-row justify-center w-full min-h-screen bg-white pt-8">
      <div className="w-full  text-sky-500 font-serif md:w-1/2 max-w-md px-4">
        ...
        <p className="text-gray-800 text-base mb-4">
          Contact us to learn more about our products. One of our specialists
          will be happy to answer your questions and help you select the best
          product for your workflow.
        </p>
